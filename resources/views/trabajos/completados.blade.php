...
@php
    ...
    $headerSubtitle = 'Listado de trabajos con estado completado';
    $headerIcon = 'fas fa-clock'; 
    
    $tableTitle = 'Lista de Trabajos Completados';
    $tableIcon = 'fas fa-list';
    
    $emptyTitle = 'No hay trabajos completados';
    $emptyMessage = 'Actualmente no hay registros en estado completado.';
    ...
    $statsCards = [
        [
            ...
            'label' => $trabajos->total() != 1 ? 'completados' : 'completado'
        ]
    ];
