...
@php
    ...
    $headerSubtitle = 'Listado de trabajos con estado pendiente';
    $headerIcon = 'fas fa-clock'; 
    
    $tableTitle = 'Lista de Trabajos Pendientes';
    $tableIcon = 'fas fa-list';
    
    $emptyTitle = 'No hay trabajos pendientes';
    $emptyMessage = 'Actualmente no hay registros en estado pendiente.';
    ...
    // Como ya estamos filtrando, las estadísticas aquí pueden ser más simples
    $statsCards = [
        [
            'icon' => 'fas fa-clock',
            'color' => 'warning',
            'value' => $trabajos->total(),
            'label' => $trabajos->total() != 1 ? 'pendientes' : 'pendiente'
        ]
    ];
