...
<div class="container-fluid">
    ...
    <div class="card form-card">
        <div class="card-body">
            ...
            <form action="{{ route('responsables.store') }}" method="POST" id="responsableForm">
                @csrf
